            ...
            {{$model->customer->phone}}
				...
				<div class="col-md-12 col-sm-12">
					<div class="row">
						...
						<div readonly id="email" name="email" class="col-6">
            {{$model->customer->email}}
				...
				<div class="col-md-12 col-sm-12">
					<div class="row">
						...
						<div readonly id="address" name="address" class="col-6">
				...
				<div class="col-md-12 col-sm-12">
					<div class="row">
						...
						<div readonly id="" name="" class="col-6" value="{{$model->delivery_name}}">
							<input type="text" value="{{$model->delivery_name}}" id="delivery_name" name="delivery_name" class="form-control">
					</div>
					</div>
				</div>
				...
				<div class="col-md-12 col-sm-12">
					<div class="row">
						...
						<div readonly id="" name="" class="col-6" value="{{$model->delivery_phone}}">
							...
							<input type="text" value="{{$model->delivery_phone}}" id="delivery_phone" name="delivery_phone"  class="form-control">
				...
				<div class="col-md-12 col-sm-12">
					<div class="row">
						...
						<div readonly id="" name="" class="col-6" value="{{$model->delivery_email}}">
							<input type="text" value="{{$model->delivery_email}}" id="delivery_email" name="delivery_email"  class="form-control">
				...
				<div class="col-md-12 col-sm-12">
					<div class="row">
						...
						<div readonly id="" name="" class="col-6" value="{{$model->delivery_address}}">
							<input type="text" value="{{$model->delivery_address}}" id="delivery_address" name="delivery_address"  class="form-control">
					...
					<div class="row">
						...
						<div readonly id="" name="" class="col-6">
							...
							<option value="">Seleccionar...</option>
								...
								<option value="{{$item->id}}"@if($model->referal_user_id == $item->id) selected="selected" @endif>{{$item->name}}</option>
								@endforeach
...
!-->
	...
	<div class="text-center"><input type="submit"  class="btn btn-primary btn-sm" value="Enviar"></div>
</form>
<br>
<br>
<!--
