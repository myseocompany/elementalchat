...
<form class="form-group" action="/orders/{cid}/create/products" method="POST">
				...
				<div class="col-md-12 col-sm-12">
					<div class="row">
						...
						<div readonly id="" name="" class="col-6" value="{{$model->delivery_name}}">
							<input type="text" value="{{$model->customer->name}}" id="delivery_name" name="delivery_name">
				...
				<div class="col-md-12 col-sm-12">
					<div class="row">
						...
						<div readonly id="" name="" class="col-6" value="{{$model->delivery_address}}">
							<input type="text" value="{{$model->customer->address}}" id="delivery_address" name="delivery_address">
				...
				<div class="col-md-12 col-sm-12">
					<div class="row">
						...
						<div readonly id="" name="" class="col-6" value="{{$model->delivery_phone}}">
							...
							<input type="text" value="{{$model->customer->phone}}" id="delivery_phone" name="delivery_phone">
...
!-->
	...
	<div><input type="submit"  class="btn btn-primary btn-sm"></div>
</form>
<br>
<br>
<!--
...
<div class="row">
	 ...
	 <div class="row">
        ...
        <input type="text" class="form-control" id="delivery_name" name="delivery_name" placeholder="Nombre..." value="{{$model->name}}">
			 ...
			 <div class="form-group">
						<label >Cedula:</label>
            <input type="text" class="form-control" id="delivery_document" name="delivery_document" placeholder="Cedula..." value="{{$model->document}}">
    </div>
				</div>
