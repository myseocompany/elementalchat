...
<table class="" border="1" id="content">
	...
	<td class="text-center subtitle" colspan="4"><h2>PRODUCTOSSSSS</h2></td>
	<tr>
		<td>PROYECTO</td>
	...
	<tr>
		...
		<td>$ {{number_format($model->product->getPrice("semi"),0)}}</td>
		<td>$ {{number_format($model->product->getPrice("full"),0)}}</td>
	</tr>
	...
	<tr>
		...
		<td>$ {{number_format($model->getSubtotal("semi"),0)}} </td>
		<td>$ {{number_format($model->getSubtotal("full"),0)}} </td>
	</tr>
	...
	<tr>
		...
		<td>$ {{number_format($model->getSubtotal("semi")*0.3,0)}} </td>
		<td>$ {{number_format($model->getSubtotal("full")*0.3,0)}} </td>
	</tr>
	<tr>
		<td>Separación</td>
	...
	<tr>
		<td>Subsidios</td>
		<td> - $ {{number_format($model->subsidy_balance,0)}} </td>
		<td> - $ {{number_format($model->subsidy_balance,0)}} </td>
		<td> - $ {{number_format($model->subsidy_balance,0)}} </td>
	</tr>
	...
	<tr>
		...
		<td>$ {{number_format($model->getMontlyInstallment("semi"),0)}} </td>
		<td>$ {{number_format($model->getMontlyInstallment("full"),0)}} </td>
	</tr>
	...
	<tr>
		...
		<td>$ {{number_format($model->getSubtotal("semi")*0.7,0)}} </td>
		<td>$ {{number_format($model->getSubtotal("full")*0.7,0)}} </td>
	</tr>
	...
	<tr>
		...
		<td>$ {{number_format($model->getMontlyUVRInstallment("semi"),0)}} </td>
		<td>$ {{number_format($model->getMontlyUVRInstallment("full"),0)}} </td>
	</tr>
	<tr>
		<td>Subsidio NO VIS <br> (primero 7 años)</td>
		<td> - $ {{number_format($model->subsidy_initial_installment,0)}} </td>
		<td> - $ {{number_format($model->subsidy_initial_installment,0)}} </td>
		<td> - $ {{number_format($model->subsidy_initial_installment,0)}} </td>
	</tr>
	<tr>
		<td>Cuota mensual aprox <br> (sin seguro de vida)</td>
		<td>$ {{number_format(($model->getMontlyUVRInstallment("black"))-$model->subsidy_initial_installment,0)}} </td>
		<td>$ {{number_format(($model->getMontlyUVRInstallment("semi"))-$model->subsidy_initial_installment,0)}} </td>
		<td>$ {{number_format(($model->getMontlyUVRInstallment("full"))-$model->subsidy_initial_installment,0)}} </td>
	</tr>
	<tr>
		<td>Ingresos necesarios aprox <br> (varían según banco)</td>
		<td>$ {{number_format(($model->getMontlyUVRInstallment("black")*100)/30,0)}} </td>
		<td>$ {{number_format(($model->getMontlyUVRInstallment("semi")*100)/30,0)}} </td>
		<td>$ {{number_format(($model->getMontlyUVRInstallment("full")*100)/30,0)}} </td>
	</tr>
