...
class OrderController extends Controller{
    ...
    public function getModel($request){	
        $model = Order::where(
        	...
        	->select(DB::raw('orders.status_id, user_id, orders.id, customer_id, delivery_date, delivery_address,  customer_id'))
            ->get();
    ...
    public function groupModel($request){	
        $model = Order::rightJoin('order_statuses','order_statuses.id', 'status_id')
        	->where(
    ...
    public function show($id){
        ...
        return view('orders.show', compact('model', 'products', 'product_types'));
    }
    ...
    public function create(){
        ...
        */
        ...
        //$customers = Customer::where('status_id','=', 8)->orderBy('name', 'ASC')->get();
    return view('orders.create', compact(/*'statuses', 'categories',*/   'customers', 'products', 'parkings', 'deposits'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $model->subsidy_value = $request->subsidy_value;
