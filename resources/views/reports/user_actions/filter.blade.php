...
<div>
    <form action="/reports/users/customer/actions" method="GET">
      ...
      <div class="row">
        ...
        <div class="col">
	        ...
	        <option value="{{$item->id}}"  @if ($item->id == $request->user_id)  selected="selected" @endif >
	        	{{$item->name}}
	        </option>
	        @endforeach
      ...
      <div class="col">	
			<select  name="action_types_id" class="slectpicker custom-select" id="action_types_id" onchange="submit();">
	        <option value="">Seleccione una acción </option>
	        @foreach($action_types as $item)
	        <option value="{{$item->id}}"  @if ($item->id == $request->action_types_id)  selected="selected" @endif >
	        	{{$item->name}}
	        </option>
	        @endforeach
	      </select>
