...
<div id="edit-order-body">
	...
	<form class="form-group" action="/orders/{{$model->id}}/update" method="POST">
		...
		{{ csrf_field() }}
						...
						<div class="col-md-12 col-sm-12">
							<div class="row">
								...
								<div readonly id="" name="" class="col-6" >
									...
									<input type="input" class="form-control" id="delivery_address" name="delivery_address" value="{{$model->delivery_address}}">
						...
						<div class="col-md-12 col-sm-12">
							<div class="row">
								...
								<div readonly id="" name="" class="col-6">
									...
									<input type="input" class="form-control" id="delivery_city" name="delivery_city"  value="{{$model->delivery_city}}">
						...
						<div class="col-md-12 col-sm-12">
							<div class="row">
								...
								<div readonly id="" name="" class="col-6" >
									...
									<input type="input" class="form-control" id="delivery_country" name="delivery_country" value="{{$model->delivery_country}}">
						...
						<div class="col-md-12 col-sm-12">
							<div class="row">
								...
								<div readonly id="" name="" class="col-6" >
									...
									<input type="input" class="form-control" id="delivery_postal_code" name="delivery_postal_code" value="{{$model->delivery_postal_code}}">
			...
			<div class="row">
				<div class="col">
					<textarea name="notes" id="notes" cols="100%" rows="4" class="form-control">{{$model->description}}</textarea>
				</div>
